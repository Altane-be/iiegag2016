...
function affichage_post($id_post,$titre_post,$nb_like,$auteur,$description){
    ...
    print "<br/>";
    print "<br/>";
    print "<div class=\"well well-sm\"><b>Description du post :</b> $description</div>";
}
...
affichage_post($id_post,$title,$nb_like,$auteur,$description);}}
?>
        </div>
    <div class="col-sm-3">
        <br/>
